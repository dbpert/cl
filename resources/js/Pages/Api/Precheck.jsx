...
export default function Precheck({ endpoint, tokenHint, requiredKeys }) {
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Precheck API</h2>}
        >
            <Head title="Precheck API" />
            ...
            <div className="py-6">
                <div className="mx-auto max-w-5xl space-y-4 sm:px-6 lg:px-8">
                    <div className="rounded-lg bg-white p-6 shadow">
                        ...
                        <p className="mt-2 text-sm text-gray-600">POST запрос для precheck-решения по трафику кампании.</p>
